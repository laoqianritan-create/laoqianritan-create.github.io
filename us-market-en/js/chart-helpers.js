// ══════════════════════════════════════════════════════
// chart-helpers.js · Reusable helpers for all echarts / chart work
...
// ══════════════════════════════════════════════════════
// Annualized holding-period matrix (used by panel-annualized-matrix)
// ══════════════════════════════════════════════════════
...
// Symmetric with negative returns: 0% → 0.18, ≥25% → 0.74
...
export function bindAnnualizedMatrixTooltip(container) {
  ...
  const showTooltip = (cell, clientX, clientY) => {
    ...
    tooltip.innerHTML = `
      <div class="matrix-tooltip-title">${escapeHtml(startYear)} → ${escapeHtml(endYear)} (Hold ${escapeHtml(holdingYears)} yr)</div>
      <div class="matrix-tooltip-line">Annualized Return: <span class="matrix-tooltip-value">${escapeHtml(cagr)}</span></div>
    `;
